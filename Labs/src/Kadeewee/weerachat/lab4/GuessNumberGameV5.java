...
/**
 * This program is GuessNumberGameV4 Improved version
 * GuessNumberGameV5 Can work like GuessNumberGameV4
 ...
 * You can type 'm' to see the lowest number you guessed in the game.
 * You can type 'x' to see the maximum number you guessed in the game.
 * You can type 'v' to see the average of all your guessed numbers.
 *
...
public class GuessNumberGameV5 {
    ...
    public static void guessAverage() {
        ...
        double average = (double)total / (double)(numGuesses);
